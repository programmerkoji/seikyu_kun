<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">掲載 - 編集</h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('posting.update', ['posting' => $posting->id]) }}" method="post">
                        ...
                        <div class="flex flex-col gap-4 md:flex-row mb-4">
                            ...
                            <div class="w-full">
                                ...
                                <select name="product_id" class="block mb-2 text-sm font-medium w-full bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    ...
                                    <option value="{{$product->id}}" @if((int)$posting->product->id===(int)$product->id) selected @endif>{{$product->name}}</option>
                                    @endforeach
                                </select>
                                @error('product_id')
                                <span class="text-rose-700 mt-2">{{ $message }}</span>
                        ...
                        <div class="w-full mb-4">
                            ...
                            <input type="text" id="content" name="content" value="{{$posting->content}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            @error('content')
                            <span class="text-rose-700 mt-2">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="flex flex-col gap-4 md:flex-row mb-4">
                            <div class="w-full">
                                ...
                                <div class="w-full flex items-center gap-1">
                                    <input type="text" id="posting_start" name="posting_start" value="{{$posting->posting_start}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
                                @error('posting_start')
                                <span class="text-rose-700 mt-2">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="w-full">
                                ...
                                <div class="w-full flex items-center gap-1">
                                    <input type="text" id="posting_term" name="posting_term" value="{{$posting->posting_term}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"><span class="whitespace-nowrap">週間</span>
                                </div>
                                @error('posting_term')
                                <span class="text-rose-700 mt-2">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="flex flex-col gap-4 md:flex-row mb-4">
                            <div class="w-full">
                                ...
                                <div class="w-full flex items-center gap-1">
                                    <input type="text" id="quantity" name="quantity" value="{{$posting->quantity}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"><span class="whitespace-nowrap">部</span>
                                </div>
                                @error('quantity')
                                <span class="text-rose-700 mt-2">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="w-full">
                                ...
                                <div class="w-full flex items-center gap-1">
                                    <input type="text" id="price" name="price" value="{{$posting->price}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"><span class="whitespace-nowrap">円</span>
                                </div>
                                @error('price')
                                <span class="text-rose-700 mt-2">{{ $message }}</span>
                                @enderror
