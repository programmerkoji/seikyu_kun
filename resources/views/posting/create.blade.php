                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('posting.store') }}" method="post">
                        ...
                        <div class="flex flex-col gap-4 md:flex-row mb-4">
                            ...
                            <div class="w-full">
                                ...
                                <select name="product_id" class="block mb-2 text-sm font-medium w-full bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    ...
                                    <option value="{{$product->id}}" @if((int)old('product_id', session('postingData.product_id'))===(int)$product->id) selected @endif>{{$product->name}}</option>
                                    @endforeach
                                </select>
                                @error('product_id')
                                <span class="text-rose-700 mt-2">{{ $message }}</span>
                        ...
                        <div class="w-full mb-4">
                            ...
                            <input type="text" id="content" name="content" value="{{old('content', session('postingData.content'))}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            @error('content')
                            <span class="text-rose-700 mt-2">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="flex flex-col gap-4 md:flex-row mb-4">
                            <div class="w-full">
                                ...
                                <div class="w-full flex items-center gap-1">
                                    <input type="text" id="posting_start" name="posting_start" value="{{old('posting_start', session('postingData.posting_start'))}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
                                @error('posting_start')
                                <span class="text-rose-700 mt-2">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="w-full">
                                ...
                                <div class="w-full flex items-center gap-1">
                                    <input type="text" id="posting_term" name="posting_term" value="{{old('posting_term', session('postingData.posting_term'))}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"><span class="whitespace-nowrap">週間</span>
                                </div>
                                @error('posting_term')
                                <span class="text-rose-700 mt-2">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="flex flex-col gap-4 md:flex-row mb-4">
                            ...
                            <div class="w-full">
                                ...
                                <div class="w-full flex items-center gap-1">
                                    <input type="text" id="price" name="price" value="{{old('price', session('postingData.price'))}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"><span class="whitespace-nowrap">円</span>
                                </div>
                                @error('price')
                                <span class="text-rose-700 mt-2">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button type="submit" class="text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-blue-700 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">請求登録へ</button>
                        </div>
                    </form>
                </div>
            </div>
