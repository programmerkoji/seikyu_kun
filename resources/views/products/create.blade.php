                        ...
                        <div class="flex flex-col gap-4 md:flex-row mb-6">
                            ...
                            <div class="w-full">
                                ...
                                <div class="w-full flex items-center gap-1">
                                    <input type="text" id="base_price" name="base_price" value="{{old('base_price')}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">円
                                </div>
                                @error('base_price')
                                <span class="text-rose-700 mt-2">{{ $message }}</span>
                                @enderror
